...
# Utilise egrep pour filtrer les deuxièmes colones des fichiers ann Cette partie utilise la commande egrep pour rechercher le mot "Location" dans les fichiers spécifiés
